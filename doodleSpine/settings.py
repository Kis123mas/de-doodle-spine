"""
Django settings for doodleSpine project.
...
SECRET_KEY = 'django-insecure-((a-ffd8i2ex)ljfx8-!hzakic$ahshqff+-^6dt-46i$r6r2l'
...
WSGI_APPLICATION = 'doodleSpine.wsgi.application'
